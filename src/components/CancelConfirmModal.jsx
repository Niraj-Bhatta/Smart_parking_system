    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-slate-950/85 backdrop-blur-md p-4 animate-in fade-in duration-200">
      <div className="bg-slate-900 border border-kalki-alert/30 rounded-3xl w-full max-w-sm overflow-hidden relative shadow-2xl shadow-red-950/20 animate-in fade-in zoom-in-95 duration-200">
        ...
        <div className="p-6 text-center">
          ...
          <h3 className="text-xl font-bold text-slate-100 mb-2 font-display uppercase tracking-wide">Cancel Reservation?</h3>
          <p className="text-slate-400 text-xs px-4 mb-6 leading-relaxed">
            Are you sure you want to release slot <span className="text-kalki-alert font-bold">{slotId}</span>? This action will free up the slot for other drivers.
          </p>
